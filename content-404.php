...
if ( is_404() ) {
	$title = __('This is somewhat embarrassing, isn&rsquo;t it?', 'persada');
	$info = __('It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help :)', 'persada');
}
else {
	$title = __('Nothing Found', 'persada');
	$info = __('Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'persada');
}
?>
